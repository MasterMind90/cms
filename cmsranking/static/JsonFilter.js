...
/**
 * Check if a source object matches a filter.
 *
 * @param {Object} source - The object to check
 * @param {Object} filter - The filter criteria
 * @param {Object} options - Options: queryHandler, match (source, filter, any, all)
 ...
 *   - if all, all keys must be exactly the same, otherwise fails
 * @returns {boolean|string} - true if matches, false if not, 'undefined' if filter is undefined
 */
function checkFilter(source, filter, options) {
